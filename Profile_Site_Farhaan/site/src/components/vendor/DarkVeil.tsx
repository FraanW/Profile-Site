/*
 * DarkVeil — vendored from React Bits (DavidHDev/react-bits),
 * src/ts-tailwind/Backgrounds/DarkVeil/DarkVeil.tsx, fetched 2026-09-16.
 * Upstream source, unmodified. Renders via WebGL2 (`ogl`).
 *
 * Do not edit this file. Palette, fallback and lifecycle wrapping live in
 * src/components/VeilField.tsx.
 */
