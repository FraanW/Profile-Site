/*
 * AeroShards — vendored from React Bits (DavidHDev/react-bits),
 * src/ts-tailwind/Backgrounds/AeroShards/AeroShards.tsx, fetched 2026-09-16.
 * Upstream source, unmodified. Renders via WebGPU (`vgpu`).
 *
 * Do not edit this file. Palette, fallback and lifecycle wrapping live in
 * src/components/ShardField.tsx.
 */
